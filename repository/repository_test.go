...
func (s *S) TestGetBranchesIntegration(c *check.C) {
	...
	c.Assert(branches[0].Name, check.Equals, "master")
	...
	c.Assert(branches[0].Links.ZipArchive, check.Equals, GetArchiveUrl(repo, "master", "zip"))
	c.Assert(branches[0].Links.TarArchive, check.Equals, GetArchiveUrl(repo, "master", "tar.gz"))
	...
	c.Assert(branches[2].Name, check.Equals, "doge_barks")
	...
	c.Assert(branches[2].Links.ZipArchive, check.Equals, GetArchiveUrl(repo, "doge_barks", "zip"))
	c.Assert(branches[2].Links.TarArchive, check.Equals, GetArchiveUrl(repo, "doge_barks", "tar.gz"))
}
